...
function printForm() {
    ...
    mywindow.document.write('<html><head><title><mdrtb:message code="mdrtb.dq.missingtb03u" text="dq"/></title>');
...
<div id="dq">
	...
	<table class="resultsTable">
	   	<tr>
	   		<th class=normal colspan="4"><mdrtb:message code="mdrtb.dq.missingtb03u" /></th>
	  	</tr>
		<tr>
...
<input type="button" onclick="tableToExcel('dq', 'missingTB03u')" value="<mdrtb:message code='mdrtb.exportToExcelBtn' />" />
