...
function printForm() {
    ...
    mywindow.document.write('<html><head><title><mdrtb:message code="mdrtb.tb03u" text="TB03y"/></title>');
...
<div id="tb03u">
	...
	<table class="resultsTable" >
	   <tr>
	     <th class="rotate" rowspan="3"><div><span><mdrtb:message code="mdrtb.tb03.registrationNumber"/></span></div></th>
	     <th class="rotate" rowspan="3"><div><span><mdrtb:message code="mdrtb.tb03.dateOfRegistration"/></span></div></th>
	     <th class="rotate" rowspan="3"><div><span><mdrtb:message code="mdrtb.tb03.tb03RegistrationYear"/></span></div></th>
	     <th class="rotate" rowspan="3"><div><span><mdrtb:message code="mdrtb.tb03.tb03registration"/></span></div></th>
	     <th class="rotate" rowspan="3"><div><span><mdrtb:message code="mdrtb.tb03.fullName"/></span></div></th>
	     <th class="rotate" rowspan="3"><div><span><mdrtb:message code="mdrtb.tb03.gender"/></span></div></th>
	     <th class="rotate" rowspan="3"><div><span><mdrtb:message code="mdrtb.tb03.ageAtRegistration"/></span></div></th>
	     <th class="rotate" rowspan="3"><div><span><mdrtb:message code="mdrtb.tb03.dateOfBirth"/></span></div></th>
	     <th class="rotate" rowspan="3"><div><span><mdrtb:message code="mdrtb.tb03.address"/></span></div></th>
		 ...
		 <th class="normal" rowspan="3"><mdrtb:message code="mdrtb.tb03.confirmedOrSuspect"/></th>
		 <th class="normal" rowspan="3"><mdrtb:message code="mdrtb.tb03.dateOfConfirmation"/></th>
		 <th class="normal" rowspan="3"><mdrtb:message code="mdrtb.tb03.treatmentRegimen"/></th>
		 <th class="normal" rowspan="3"><mdrtb:message code="mdrtb.tb03.treatmentStartDate"/></th>
		 <th class="rotate" rowspan="3"><div><span><mdrtb:message code="mdrtb.tb03.ambulatoryHosp"/></span></div></th>
		 <th class="normal" rowspan="3" rowspan="2"><mdrtb:message code="mdrtb.tb03.dstSampleCollectionDate"/></th>
		 <th class="normal" rowspan="3"><mdrtb:message code="mdrtb.tb03.dstResultDate"/></th>
		 <th class="reggroup" colspan="17" rowspan="2"><mdrtb:message code="mdrtb.tb03.dst"/></th>
		 <th class="normal" colspan="4"><mdrtb:message code="mdrtb.tb03.genexpert"/></th>
	   	 <th class="normal" colspan="6" ><mdrtb:message code="mdrtb.tb03.hain"/></th>
	   	 <th class="normal" colspan="6" ><mdrtb:message code="mdrtb.tb03.hain2"/></th>
		 <th class="normal" rowspan="3"><mdrtb:message code="mdrtb.tb03.drugResistance"/></th>
	     <th class="normal" rowspan="3"><mdrtb:message code="mdrtb.tb03.diagnosticMethod"/></th>
		 <th class="reggroup" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.tbHivActivities"/></th>
		 <th class="normal" colspan="84"><mdrtb:message code="mdrtb.tb03.bacCultureResults"/></th>
		  <th class="reggroup" rowspan="1" colspan="6"><mdrtb:message code="mdrtb.tb03.treatmentOutcomeDate"/></th> 
		 <th class="rotate" rowspan="3"><div><span><mdrtb:message code="mdrtb.tb03.transferOut"/></span></div></th>
		 <th class="normal" rowspan="3"><mdrtb:message code="mdrtb.tb03.relapseYesNo"/></th>
		  <th class="normal" rowspan="3"><div><span><mdrtb:message code="mdrtb.tb03.relapseTxMonth"/></span></div></th>
		 <th class="normal" rowspan="3"><mdrtb:message code="mdrtb.tb03.notes"/></th>
	  </tr>
	   <tr>
	   	 
	   	  <th class="subrotate" rowspan="2"><div><span><mdrtb:message code="mdrtb.tb03.new"/></span></div></th>
	   	 <th class="subrotate" rowspan="1" colspan="2"><div><span><mdrtb:message code="mdrtb.tb03.relapseAfter"/></span></div></th>
	   	 
	   	
	   	 <th class="subrotate" rowspan="1" colspan="2"><div><span><mdrtb:message code="mdrtb.tb03.defaultAfter"/></span></div></th>
	   	<!-- <th class="subrotate" rowspan="1"><div><span><mdrtb:message code="mdrtb.tb03.defaultAfter"/>Default After Treatment<br/>on Regimen </span></div></th> --> 
	   	 <th class="subrotate" rowspan="1" colspan="2"><div><span><mdrtb:message code="mdrtb.tb03.failureAfter"/></span></div></th>
	   	 <!-- <th class="subrotate" rowspan="1"><div><span><mdrtb:message code="mdrtb.tb03.failureAfter"/>Failure After Treatment<br/>on Regimen</span></div></th> -->
	   	 <th class="subrotate" rowspan="2"><div><span><mdrtb:message code="mdrtb.tb03.other"/></span></div></th>
	    
	   	 
	   	 
	   	 <th class="normal" rowspan="2"><mdrtb:message code="mdrtb.tb03.xpertResult"/></th>
	   	  <th rowspan="2"><mdrtb:message code="mdrtb.tb03.date"/></th>
	   		<th rowspan="2"><mdrtb:message code="mdrtb.tb03.testNumber"/></th>
	   		<th rowspan="2"><mdrtb:message code="mdrtb.lab"/></th>
	   		
	   	   <th class="normal" rowspan="2"><mdrtb:message code="mdrtb.tb03.date"/></th>
	   	   <th rowspan="2"><mdrtb:message code="mdrtb.tb03.testNumber"/></th>
	   	   <th class="normal" rowspan="2"><mdrtb:message code="mdrtb.tb03.hainCultureResult"/></th>
	   	   <th rowspan="2"><mdrtb:message code="mdrtb.tb03.hResult"/></th>
	   		<th rowspan="2"><mdrtb:message code="mdrtb.tb03.rResult"/></th>
	   		<th rowspan="2"><mdrtb:message code="mdrtb.lab"/></th>
	   		
	   	   <th class="normal" rowspan="2"><mdrtb:message code="mdrtb.tb03.date"/></th>
	   	   <th rowspan="2"><mdrtb:message code="mdrtb.tb03.testNumber"/></th>
	   	   <th class="normal" rowspan="2" ><mdrtb:message code="mdrtb.tb03.hainCultureResult"/></th>
	   		<th rowspan="2"><mdrtb:message code="mdrtb.tb03.iResult"/></th>
	   		<th rowspan="2"><mdrtb:message code="mdrtb.tb03.fResult"/></th>
	   		<th rowspan="2"><mdrtb:message code="mdrtb.lab"/></th>
	   	 
	   	  <th class="normal" rowspan="1" colspan="2"><mdrtb:message code="mdrtb.tb03.hivTest"/></th>
	   	  <th class="normal" rowspan="2"><mdrtb:message code="mdrtb.tb03.artTest"/></th>
	   	  <th class="normal" rowspan="2"><mdrtb:message code="mdrtb.tb03.cpTest"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month0"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month1"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month2"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month3"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month4"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month5"/></th>
	   	   <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month6"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month7"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month8"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month9"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month10"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month11"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month12"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month15"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month18"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month21"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month24"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month27"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month30"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month33"/></th>
	   	  <th class="normal" rowspan="1" colspan="4"><mdrtb:message code="mdrtb.tb03.month36"/></th>
	   ...
	   <tr>
	   	 ...
	   	 <th class="dst" rowspan="1"><div>Dlm</div></th>
	   		 ...
	   		 <th class="normal"><mdrtb:message code="mdrtb.tb03.yesNoDate"/></th>
	   	 <th class="normal"><mdrtb:message code="mdrtb.tb03.resultPosNeg"/></th>	
	   		
	   
	   	<th class="normal" colspan="2"><mdrtb:message code="mdrtb.tb03.smearShort"/></th>
	        <th class="normal" colspan="2"><mdrtb:message code="mdrtb.tb03.cultureShort"/></th>
	        <th class="normal" colspan="2"><mdrtb:message code="mdrtb.tb03.smearShort"/></th>
	        <th class="normal" colspan="2"><mdrtb:message code="mdrtb.tb03.cultureShort"/></th>
	        <th class="normal" colspan="2"><mdrtb:message code="mdrtb.tb03.smearShort"/></th>
	        <th class="normal" colspan="2"><mdrtb:message code="mdrtb.tb03.cultureShort"/></th>
	        ...
	        <th class="normal" colspan="2"><mdrtb:message code="mdrtb.tb03.smearShort"/></th>
	        <th class="normal" colspan="2"><mdrtb:message code="mdrtb.tb03.cultureShort"/></th>
	        <th class="normal"><div><span><mdrtb:message code="mdrtb.tb03.ofTb"/></span></div></th>
	   	   <th class="normal"><div><span><mdrtb:message code="mdrtb.tb03.ofOther"/></span></div></th>
...
<input type="button" onclick="tableToExcel('tb03u', 'TB03u')" value="<mdrtb:message code='mdrtb.exportToExcelBtn' />" />
