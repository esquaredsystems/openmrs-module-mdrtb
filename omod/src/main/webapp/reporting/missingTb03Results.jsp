...
function printForm() {
    ...
    mywindow.document.write('<html><head><title><mdrtb:message code="mdrtb.dq.missingTb03" text="dq"/></title>');
...
<input type="button" onclick="tableToExcel('dq', 'missingTB03')" value="<mdrtb:message code='mdrtb.exportToExcelBtn' />" />
