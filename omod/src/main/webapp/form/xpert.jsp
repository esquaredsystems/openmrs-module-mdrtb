...
<b class="boxHeader"><mdrtb:message code="mdrtb.xpert" text="Xpert Form"/>
<openmrs:hasPrivilege privilege="Edit DOTS-MDR Data">
<span style="position: absolute; right:30px;"><a id="edit" onmouseover="document.body.style.cursor='pointer'" onmouseout="document.body.style.cursor='default'"><mdrtb:message code="mdrtb.edit" text="edit"/></a>&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/module/mdrtb/visits/delete.form?visitId=${xpert.id}&patientProgramId=${patientProgramId}&patientId=${xpert.patient.id }" class="delete" onclick="return confirm('<mdrtb:message code="mdrtb.confirmDeleteVisit" text="Are you sure you want to delete this visit?"/>')"><mdrtb:message code="mdrtb.delete" text="delete"/></a></span>
...
<b class="boxHeader"><mdrtb:message code="mdrtb.xpert" text="Xpert"/></b>
<div class="box">
