...
<script type="text/javascript">
	...
	function printForm() {
	    ...
	    mywindow.document.write('<html><head><title><mdrtb:message code="mdrtb.pv.regimenForm" text="Regimen"/></title>');
	    mywindow.document.write('</head><body >');
	    mywindow.document.write('<h1><mdrtb:message code="mdrtb.pv.regimenForm" text="Regimen"/></h1>');
	...
	function validate() 
	{
		...
		if(encDate=="") {
			errorText = ""  + '<mdrtb:message code="mdrtb.error.missingRegimenDate"/>' + "";
			alert(errorText);
			return false;
		}
		
		if(cmacDate=="") {
			errorText = ""  + '<mdrtb:message code="mdrtb.error.missingCmacDate"/>' + "";
			alert(errorText);
			return false;
		}
		...
		if(regimenDate.getTime() > now.getTime()) {
			errorText = ""  + '<mdrtb:message code="mdrtb.error.regimenDateInFuture"/>' + "";
			alert(errorText);
			return false;
		}
		
		if(councilDate.getTime() > now.getTime()) {
			errorText = ""  + '<mdrtb:message code="mdrtb.error.cmacDateInFuture"/>' + "";
			alert(errorText);
			return false;
		}
...
<b class="boxHeader"><mdrtb:message code="mdrtb.pv.addRegimen" text="Add Regimen"/>
<span style="position: absolute; right:30px;"><a id="print" onmouseover="document.body.style.cursor='pointer'" onmouseout="document.body.style.cursor='default'" onclick="printForm()"><mdrtb:message code="mdrtb.print" text="Regimen"/></a>
&nbsp;&nbsp;<a id="export" onmouseover="document.body.style.cursor='pointer'" onmouseout="document.body.style.cursor='default'" onclick="tableToExcel('regimen', 'Regimen')"><mdrtb:message code="mdrtb.exportToExcel" text="Export"/></a>
...
&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/module/mdrtb/visits/delete.form?visitId=${regimenForm.id}&patientProgramId=${patientProgramId}&patientId=${regimenForm.patient.id }" class="delete" onclick="return confirm('<mdrtb:message code="mdrtb.confirmDeleteVisit" text="Are you sure you want to delete this visit?"/>')"><mdrtb:message code="mdrtb.delete" text="delete"/></a>
...
<tr>
<td><mdrtb:message code="mdrtb.pv.cmacDate" text="CMAC date"/>:</td>
...
<tr>
<td><mdrtb:message code="mdrtb.form89.placeOfCommission" text="Tx Site CP"/>:</td>
<td>${regimenForm.placeOfCommission.displayString}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.tb03.resistanceType" text="resTypesz"/>:</td>
<td>${regimenForm.resistanceType}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.fundingSource" text="Fundingz"/>:</td>
<td>${regimenForm.fundingSource.displayString}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.sldRegimenType" text="typez"/>:</td>
<td>${regimenForm.sldRegimenType.displayString}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.otherRegimen" text="otherz"/>:</td>
<td>${regimenForm.otherRegimen}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.cmDose" text="cmDose"/>:</td>
<td>${regimenForm.cmDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.amDose" text="amDose"/>:</td>
<td>${regimenForm.amDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.mfxDose" text="mfxDose"/>:</td>
<td>${regimenForm.mfxDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.lfxDose" text="lfxDose"/>:</td>
<td>${regimenForm.lfxDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.ptoDose" text="ptoDose"/>:</td>
<td>${regimenForm.ptoDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.csDose" text="csDose"/>:</td>
<td>${regimenForm.csDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.pasDose" text="pasDose"/>:</td>
<td>${regimenForm.pasDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.zDose" text="zDose"/>:</td>
<td>${regimenForm.ZDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.eDose" text="eDose"/>:</td>
<td>${regimenForm.EDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.hDose" text="hDose"/>:</td>
<td>${regimenForm.HDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.lzdDose" text="lzdDose"/>:</td>
<td>${regimenForm.lzdDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.cfzDose" text="cfzDose"/>:</td>
<td>${regimenForm.cfzDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.bdqDose" text="bdqDose"/>:</td>
<td>${regimenForm.bdqDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.dlmDose" text="dlmDose"/>:</td>
<td>${regimenForm.dlmDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.impDose" text="impDose"/>:</td>
<td>${regimenForm.impDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.amxDose" text="amxDose"/>:</td>
<td>${regimenForm.amxDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.hrDose" text="hrDose"/>:</td>
<td>${regimenForm.hrDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.hrzeDose" text="hrzeDose"/>:</td>
<td>${regimenForm.hrzeDose}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.sDose" text="sDose"/>:</td>
<td>${regimenForm.SDose}</td>
</tr>

<tr>
<td colspan="2" align="left"><mdrtb:message code="mdrtb.pv.other" text="Otherz"/></td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.otherDrug1Name" text="otherDrug1Name"/>:</td>
<td>${regimenForm.otherDrug1Name}</td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.pv.otherDrug1Dose" text="otherDrug1Dose"/>:</td>
...
<b class="boxHeader"><mdrtb:message code="mdrtb.regimenForm" text="regimenForm"/></b>
<div class="box">
...
<tr>
<td><mdrtb:message code="mdrtb.pv.cmacDate" text="CMAC Datez"/>:</td>
<td><openmrs_tag:dateField formFieldName="councilDate" startValue="${regimenForm.councilDate}"/></td>
</tr>

<tr>
<td><mdrtb:message code="mdrtb.form89.cmacNumber" text="CMAC Numberz"/>:</td>
...
<tr>
<td><mdrtb:message code="mdrtb.pv.fundingSource" text="Fundz"/>:</td>
<td>
