...
@Resource(name = RestConstants.VERSION_1 + "/mdrtb/tb08report", supportedClass = SimpleTB08Data.class, supportedOpenmrsVersions = { "2.2.*,2.3.*,2.4.*,2.8.*" })
public class TB08DataResourceController extends BaseReportResource<SimpleTB08Data> implements Searchable {
	...
	protected PageableResult doSearch(RequestContext context) {
		...
		TB08Data tb08Data = TB08ReportController.getTB08PatientSet(year, quarter, month, month2, locList);
