...
public class SimpleTB03uData extends BaseOpenmrsData {
	...
	public SimpleTB03uData(TB03uData tb03uData) {
		this.patientUuid = tb03uData.getPatient().getUuid();
		this.personName = tb03uData.getPatient().getPersonName();
		this.gender = tb03uData.getGender();
		this.personAddress = tb03uData.getPatient().getPersonAddress();
		this.identifierDOTS = tb03uData.getIdentifierDOTS();
		this.dotsYear = tb03uData.getDotsYear();
		this.identifierMDR = tb03uData.getIdentifierMDR();
		this.tb03uRegistrationDate = tb03uData.getTb03uRegistrationDate();
		this.ageAtTB03uRegistration = tb03uData.getAgeAtTB03uRegistration();
		this.tb03uFacility = null;
		if (tb03uData.getTb03uLocation() != null) {
			this.tb03uFacility = tb03uData.getTb03uLocation().getName();
		}
		this.dateOfBirth = tb03uData.getDateOfBirth();
		this.reg2Number = tb03uData.getReg2Number();
		this.siteOfDisease = tb03uData.getSiteOfDisease();
		this.regGroup = tb03uData.getRegGroup();
		this.mdrtbStatus = tb03uData.getMdrtbStatus();
		this.mdrConfDate = tb03uData.getMdrConfDate();
		this.treatmentRegimen = tb03uData.getTreatmentRegimen();
		this.tb03uTreatmentStartDate = tb03uData.getTb03uTreatmentStartDate();
		this.treatmentLocation = tb03uData.getTreatmentLocation();
		this.dstCollectionDate = tb03uData.getDstCollectionDate();
		this.dstResultDate = tb03uData.getDstResultDate();
		this.drugResistance = tb03uData.getDrugResistance();
		this.diagnosticMethod = tb03uData.getDiagnosticMethod();
		this.hivTestResult = tb03uData.getHivTestResult();
		this.hivTestDate = tb03uData.getHivTestDate();
		this.artStartDate = tb03uData.getArtStartDate();
		this.cpStartDate = tb03uData.getCpStartDate();
		this.month0SmearResult = tb03uData.getMonth0SmearResult();
		this.month1SmearResult = tb03uData.getMonth1SmearResult();
		this.month2SmearResult = tb03uData.getMonth2SmearResult();
		this.month3SmearResult = tb03uData.getMonth3SmearResult();
		this.month4SmearResult = tb03uData.getMonth4SmearResult();
		this.month5SmearResult = tb03uData.getMonth5SmearResult();
		this.month6SmearResult = tb03uData.getMonth6SmearResult();
		this.month7SmearResult = tb03uData.getMonth7SmearResult();
		this.month8SmearResult = tb03uData.getMonth8SmearResult();
		this.month9SmearResult = tb03uData.getMonth9SmearResult();
		this.month10SmearResult = tb03uData.getMonth10SmearResult();
		this.month11SmearResult = tb03uData.getMonth11SmearResult();
		this.month12SmearResult = tb03uData.getMonth12SmearResult();
		this.month15SmearResult = tb03uData.getMonth15SmearResult();
		this.month18SmearResult = tb03uData.getMonth18SmearResult();
		this.month21SmearResult = tb03uData.getMonth21SmearResult();
		this.month24SmearResult = tb03uData.getMonth24SmearResult();
		this.month27SmearResult = tb03uData.getMonth27SmearResult();
		this.month30SmearResult = tb03uData.getMonth30SmearResult();
		this.month33SmearResult = tb03uData.getMonth33SmearResult();
		this.month36SmearResult = tb03uData.getMonth36SmearResult();
		this.month0SmearResultDate = tb03uData.getMonth0SmearResultDate();
		this.month1SmearResultDate = tb03uData.getMonth1SmearResultDate();
		this.month2SmearResultDate = tb03uData.getMonth2SmearResultDate();
		this.month3SmearResultDate = tb03uData.getMonth3SmearResultDate();
		this.month4SmearResultDate = tb03uData.getMonth4SmearResultDate();
		this.month5SmearResultDate = tb03uData.getMonth5SmearResultDate();
		this.month6SmearResultDate = tb03uData.getMonth6SmearResultDate();
		this.month7SmearResultDate = tb03uData.getMonth7SmearResultDate();
		this.month8SmearResultDate = tb03uData.getMonth8SmearResultDate();
		this.month9SmearResultDate = tb03uData.getMonth9SmearResultDate();
		this.month10SmearResultDate = tb03uData.getMonth10SmearResultDate();
		this.month11SmearResultDate = tb03uData.getMonth11SmearResultDate();
		this.month12SmearResultDate = tb03uData.getMonth12SmearResultDate();
		this.month15SmearResultDate = tb03uData.getMonth15SmearResultDate();
		this.month18SmearResultDate = tb03uData.getMonth18SmearResultDate();
		this.month21SmearResultDate = tb03uData.getMonth21SmearResultDate();
		this.month24SmearResultDate = tb03uData.getMonth24SmearResultDate();
		this.month27SmearResultDate = tb03uData.getMonth27SmearResultDate();
		this.month30SmearResultDate = tb03uData.getMonth30SmearResultDate();
		this.month33SmearResultDate = tb03uData.getMonth33SmearResultDate();
		this.month36SmearResultDate = tb03uData.getMonth36SmearResultDate();
		this.month0CultureResult = tb03uData.getMonth0CultureResult();
		this.month1CultureResult = tb03uData.getMonth1CultureResult();
		this.month2CultureResult = tb03uData.getMonth2CultureResult();
		this.month3CultureResult = tb03uData.getMonth3CultureResult();
		this.month4CultureResult = tb03uData.getMonth4CultureResult();
		this.month5CultureResult = tb03uData.getMonth5CultureResult();
		this.month6CultureResult = tb03uData.getMonth6CultureResult();
		this.month7CultureResult = tb03uData.getMonth7CultureResult();
		this.month8CultureResult = tb03uData.getMonth8CultureResult();
		this.month9CultureResult = tb03uData.getMonth9CultureResult();
		this.month10CultureResult = tb03uData.getMonth10CultureResult();
		this.month11CultureResult = tb03uData.getMonth11CultureResult();
		this.month12CultureResult = tb03uData.getMonth12CultureResult();
		this.month15CultureResult = tb03uData.getMonth15CultureResult();
		this.month18CultureResult = tb03uData.getMonth18CultureResult();
		this.month21CultureResult = tb03uData.getMonth21CultureResult();
		this.month24CultureResult = tb03uData.getMonth24CultureResult();
		this.month27CultureResult = tb03uData.getMonth27CultureResult();
		this.month30CultureResult = tb03uData.getMonth30CultureResult();
		this.month33CultureResult = tb03uData.getMonth33CultureResult();
		this.month36CultureResult = tb03uData.getMonth36CultureResult();
		this.month0CultureResultDate = tb03uData.getMonth0CultureResultDate();
		this.month1CultureResultDate = tb03uData.getMonth1CultureResultDate();
		this.month2CultureResultDate = tb03uData.getMonth2CultureResultDate();
		this.month3CultureResultDate = tb03uData.getMonth3CultureResultDate();
		this.month4CultureResultDate = tb03uData.getMonth4CultureResultDate();
		this.month5CultureResultDate = tb03uData.getMonth5CultureResultDate();
		this.month6CultureResultDate = tb03uData.getMonth6CultureResultDate();
		this.month7CultureResultDate = tb03uData.getMonth7CultureResultDate();
		this.month8CultureResultDate = tb03uData.getMonth8CultureResultDate();
		this.month9CultureResultDate = tb03uData.getMonth9CultureResultDate();
		this.month10CultureResultDate = tb03uData.getMonth10CultureResultDate();
		this.month11CultureResultDate = tb03uData.getMonth11CultureResultDate();
		this.month12CultureResultDate = tb03uData.getMonth12CultureResultDate();
		this.month15CultureResultDate = tb03uData.getMonth15CultureResultDate();
		this.month18CultureResultDate = tb03uData.getMonth18CultureResultDate();
		this.month21CultureResultDate = tb03uData.getMonth21CultureResultDate();
		this.month24CultureResultDate = tb03uData.getMonth24CultureResultDate();
		this.month27CultureResultDate = tb03uData.getMonth27CultureResultDate();
		this.month30CultureResultDate = tb03uData.getMonth30CultureResultDate();
		this.month33CultureResultDate = tb03uData.getMonth33CultureResultDate();
		this.month36CultureResultDate = tb03uData.getMonth36CultureResultDate();
		
		this.tb03uTreatmentOutcome = tb03uData.getTb03uTreatmentOutcome();
		this.tb03uTreatmentOutcomeDate = tb03uData.getTb03uTreatmentOutcomeDate();
		this.diedOfTB = tb03uData.getDiedOfTB();
		this.xpertMTBResult = tb03uData.getXpertMTBResult();
		this.xpertRIFResult = tb03uData.getXpertRIFResult();
		this.xpertTestDate = tb03uData.getXpertTestDate();
		this.xpertTestNumber = tb03uData.getXpertTestNumber();
		this.xpertLab = tb03uData.getXpertLab();
		this.hainMTBResult = tb03uData.getDstResultDate();
		this.hainINHResult = tb03uData.getHainINHResult();
		this.hainRIFResult = tb03uData.getHainRIFResult();
		this.hainTestDate = tb03uData.getHainTestDate();
		this.hainTestNumber = tb03uData.getHainTestNumber();
		this.hainLab = tb03uData.getHainLab();
		this.hain2MTBResult = tb03uData.getHain2MTBResult();
		this.hain2InjResult = tb03uData.getHain2InjResult();
		this.hain2FqResult = tb03uData.getHain2FqResult();
		this.hain2TestDate = tb03uData.getHain2TestDate();
		this.hain2TestNumber = tb03uData.getHain2TestNumber();
		this.hain2Lab = tb03uData.getHain2Lab();
		this.relapsed = tb03uData.getRelapsed();
		this.relapseMonth = tb03uData.getRelapseMonth();
		this.notes = tb03uData.getNotes();
		this.dstResults = tb03uData.getDstResults();
	}
	...
	public String getTb03uFacility() {
		return tb03uFacility;
	}
	
	public void setTb03uFacility(String tb03uFacility) {
		this.tb03uFacility = tb03uFacility;
	}
