...
//TODO: Remove this class and move the mappings to liquibase.xml
@Controller
public class SpecimenMigrationController {
	...
	//		addConceptMapping(MdrtbConcepts.DST_CONTAMINATED, "DRUG SENSITIVITY TEST CONTAMINATED");
	//		addConceptMapping(MdrtbConcepts.WAITING_FOR_TEST_RESULTS, "WAITING FOR TEST RESULTS");
	//		addConceptMapping(MdrtbConcepts.SCANNED_LAB_REPORT, "LAB TEST REPORT, SCANNED");
	//		addConceptMapping(MdrtbConcepts.SPECIMEN_APPEARANCE, "APPEARANCE OF SPUTUM SPECIMEN");
	//		addConceptMapping(MdrtbConcepts.SPUTUM, MdrtbConcepts.SPUTUM);
	//		addConceptMapping(MdrtbConcepts.STRONGLY_POSITIVE, MdrtbConcepts.STRONGLY_POSITIVE);
	//		addConceptMapping(MdrtbConcepts.MODERATELY_POSITIVE, MdrtbConcepts.MODERATELY_POSITIVE);
	//		addConceptMapping(MdrtbConcepts.WEAKLY_POSITIVE, MdrtbConcepts.WEAKLY_POSITIVE);
	//		addConceptMapping(MdrtbConcepts.POSITIVE, MdrtbConcepts.POSITIVE);
	//		addConceptMapping(MdrtbConcepts.NEGATIVE, MdrtbConcepts.NEGATIVE);
	//		addConceptMapping(MdrtbConcepts.CONTAMINATED, MdrtbConcepts.CONTAMINATED);
	//		addConceptMapping(MdrtbConcepts.ANTIRETROVIRALS, "ANTIRETROVIRAL DRUGS");
	//		
	//		// TODO: probably should add all the drug concepts that I mapped manually here...
	//		
	//		// add new concepts
	//		// NOTE: need to add french names as well!
	//		addConcept("TUBERCULOSIS SPECIMEN ID", "Specimen", "Text", "TUBERCULOSIS SPECIMEN ID", MdrtbConcepts.MDRTB_CONCEPT_MAPPING_CODE);
	//		addConcept("TUBERCULOSIS TEST DATE ORDERED", "Question", "Date", "TUBERCULOSIS TEST DATE ORDERED",
	//		    MdrtbConcepts.MDRTB_CONCEPT_MAPPING_CODE); // worry about there being two "Date" concept datatypes?
	//		addConcept("TUBERCULOSIS SPECIMEN COMMENTS", "Finding", "Text", "TUBERCULOSIS SPECIMEN COMMENTS",
	//		    MdrtbConcepts.MDRTB_CONCEPT_MAPPING_CODE);
	//		
	//		addConcept("PHYSICAN-REPORTED TUBERCULOSIS SMEAR MICROSCOPY CONSTRUCT", "Misc", "N/A",
	//		    "PHYSICAN-REPORTED TUBERCULOSIS SMEAR MICROSCOPY CONSTRUCT", MdrtbConcepts.MDRTB_CONCEPT_MAPPING_CODE);
	//		addConcept("PHYSICAN-REPORTED TUBERCULOSIS SMEAR RESULT", "Test", "Coded",
	//		    "PHYSICAN-REPORTED TUBERCULOSIS SMEAR RESULT", MdrtbConcepts.MDRTB_CONCEPT_MAPPING_CODE);
	//		
	//		// modify concepts
	//		
	//		// haiti-specific?
	...
	//		addAnswerConcept(physicanSmearResult, Context.getConceptService().getConceptByName(MdrtbConcepts.POSITIVE));
	//		addAnswerConcept(physicanSmearResult, Context.getConceptService().getConceptByName(MdrtbConcepts.NEGATIVE));
	//		
	...
	//		addAnswerConcept(cultureResult, Context.getConceptService().getConceptByName(MdrtbConcepts.POSITIVE));
	//		
	...
	//		
	//		// THIOACETAZONE
	//		Concept thio = Context.getConceptService().getConceptByName(MdrtbConcepts.THIOACETAZONE);
	...
	//			if (map.getSourceCode().equals(MdrtbConcepts.PULMONARY_TB)) {
	...
	//		for (Encounter encounter : Context.getService(MdrtbService.class).getEncounters(null, null, null, null, intakeOrFollowup)) {
	...
	//		for (Encounter encounter : Context.getService(MdrtbService.class).getEncounters(null, null, null, null, specimenEncounter)) {
	//			// to handle any test patients where the encounter hasn't been voided for some reason
	//			if (encounter.getPatient().isVoided()) {
	//				log.info("Voiding encounter " + encounter.getId() + " because it belongs to a voided patient");
	//				Context.getEncounterService().voidEncounter(encounter, "voided as part of mdr-tb migration");
	...
	//		Concept hospitalizedConcept = Context.getConceptService().getConcept(MdrtbConcepts.PATIENT_HOSPITALIZED);
	//		ConceptMap map = new ConceptMap();
	//		map.setSource(Context.getConceptService().getConceptSourceByName(MdrtbConcepts.MDRTB_CONCEPT_MAPPING_CODE));
	//		map.setSourceCode(MdrtbConcepts.PATIENT_HOSPITALIZED);
	...
	//			
	//			if (order != null && order.getEffectiveStopDate() != null && order.isDiscontinuedRightNow()
	//			        && order.getEffectiveStopDate().after(today)) {
	//				String reason = "Resetting discontinued state on order " + order.getId()
	//		        + " to null; discontinued date erronously in the future (" + order.getEffectiveStopDate() + ")";
	//				log.warn(reason);
	...
	//		addConcept("NEW", "Misc", "N/A", "NEW", MdrtbConcepts.MDRTB_CONCEPT_MAPPING_CODE);
	//		addConcept("PATIENT_TRANSFERRED_IN", "Misc", "N/A", "PATIENT_TRANSFERRED_IN", MdrtbConcepts.MDRTB_CONCEPT_MAPPING_CODE);
	//		
	...
	//	 */
	//	public PatientState getPatientState(PatientProgram program, Concept workflowConcept) {
