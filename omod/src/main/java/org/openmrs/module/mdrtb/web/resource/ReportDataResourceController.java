...
import org.openmrs.module.mdrtb.web.dto.SimpleReportObject;
...
@Resource(name = RestConstants.VERSION_1 + "/mdrtb/reportdata", supportedClass = SimpleReportObject.class, supportedOpenmrsVersions = { "2.2.*,2.3.*,2.4.*" })
public class ReportDataResourceController extends DataDelegatingCrudResource<SimpleReportObject> implements Searchable {
	...
	@Override
	public SimpleReportObject newDelegate() {
		SimpleReportObject reportObject = new SimpleReportObject();
		reportObject.setReportStatus(ReportStatus.UNLOCKED);
		return reportObject;
	}
	
	@PropertyGetter("display")
	public String getDisplayString(SimpleReportObject reportObject) {
	...
	@Override
	public SimpleReportObject getByUniqueId(String uuid) {
		...
		return new SimpleReportObject(reportData);
	}
	
	@Override
	public SimpleReportObject save(SimpleReportObject delegate) throws ResponseException {
	...
	@Override
	protected void delete(SimpleReportObject delegate, String reason, RequestContext context) throws ResponseException {
		service.voidReportData(delegate.toReportData(), reason);
	}
	
	@Override
	public void purge(SimpleReportObject delegate, RequestContext context) throws ResponseException {
	...
	protected PageableResult doSearch(RequestContext context) {
		...
		List<SimpleReportObject> reportObjects = new ArrayList<>();
		for (ReportData reportData : list) {
			reportObjects.add(new SimpleReportObject(reportData));
		}
		return new NeedsPaging<SimpleReportObject>(reportObjects, context);
	}
}
