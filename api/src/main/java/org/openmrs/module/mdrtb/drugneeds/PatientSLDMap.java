...
public class PatientSLDMap {
	...
	public PatientSLDMap(Patient patient, Date treatmentStartDate, Boolean onCapreomycin, Boolean onAmikacin,
	    Boolean onMoxifloxacin, Boolean onLevofloxacin, Boolean onProthionamide, Boolean onCycloserine, Boolean onPAS,
	    Boolean onPyrazinamide, Boolean onEthambutol, Boolean onOther1, Boolean onOther2, Boolean onOther3,
	    Boolean onOther4, Boolean onOther5) {
		super();
