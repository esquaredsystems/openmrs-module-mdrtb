...
public class WHOForm06TJK implements ReportSpecification {
	...
	public String getName() {
		return Context.getService(MessagePropertyService.class).getMessage("mdrtb.form06");
	}
	...
	public String getDescription() {
		return Context.getService(MessagePropertyService.class).getMessage("mdrtb.form06.title");
	}
	...
	public List<Parameter> getParameters() {
		...
		l.add(new Parameter("quarter", Context.getService(MessagePropertyService.class).getMessage("mdrtb.quarter"), String.class));
		return l;
	}
	...
	public ReportData evaluateReport(EvaluationContext context) {
		...
		CohortDefinition positiveResult = Cohorts.getMdrtbBacResultAfterTreatmentStart(startDate, endDate, 8, 9,
		    Result.POSITIVE);
		CohortDefinition negativeResult = Cohorts.getMdrtbBacResultAfterTreatmentStart(startDate, endDate, 8, 9,
		    Result.NEGATIVE);
		CohortDefinition unknownResult = Cohorts.getMdrtbBacResultAfterTreatmentStart(startDate, endDate, 8, 9,
		    Result.UNKNOWN);
