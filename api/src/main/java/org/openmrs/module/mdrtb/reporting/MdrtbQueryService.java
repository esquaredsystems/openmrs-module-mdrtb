...
public class MdrtbQueryService {
	...
	/**
	 * @return the Cohort of patients whose test results indicate resistance to at least one of the
	 *         passed drugs
	 */
	public static Cohort getPatientsResistantToAnyDrugs(EvaluationContext context, Date minResultDate, Date maxResultDate,
	        Concept... drugs) {
		
		Integer resistant = Context.getService(MdrtbService.class).getConcept(MdrtbConcepts.RESISTANT_TO_TB_DRUG)
		        .getConceptId();
	...
	/**
	 * Returns the patients who have tested resistant for x or more drugs during the given time
	 * period, where x = numberOfDrugs
	 */
	public static Cohort getPatientsResistantToNumberOfDrugs(EvaluationContext context, Date minResultDate,
	        Date maxResultDate, Integer numberOfDrugs) {
	...
	public static Cohort getPatientsByResitantType(EvaluationContext context, Date minResultDate, Date maxResultDate,
	        TbClassification rType) {
		
		Integer resistanceType = Context.getService(MdrtbService.class).getConcept(MdrtbConcepts.RESISTANCE_TYPE)
		        .getConceptId();
		
		Integer type = null;
		
		switch (rType) {
			case RIF_RESISTANT_TB:
	...
	public static Cohort getTreatmentStarted(EvaluationContext context, Date minResultDate, Date maxResultDate) {
		...
		Integer mdrTreatmentStartDate = Context.getService(MdrtbService.class)
	...
	public static Cohort getPatientsWithSLDRegimenType(EvaluationContext context, Date startDate, Date endDate,
	        Concept regType) {
		
		Integer regimenType = Context.getService(MdrtbService.class).getConcept(MdrtbConcepts.TUBERCULOSIS_PATIENT_CATEGORY)
		        .getConceptId();
	 ...
	 */
	public static Cohort getPatientsReferredToTest(EvaluationContext context, Date minReferralDate, Date maxReferralDate,
	        String testType) {
