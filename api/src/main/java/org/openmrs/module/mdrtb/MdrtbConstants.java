...
public class MdrtbConstants {
	...
	@Deprecated
	public static final String ENROLLMENT_LOCATION_TAG_UUID = "1c783dca-fd54-4ea8-a0fc-2875374e9cb6";
	...
	public static final String GP_SPECIMEN_REPORTS_DEFAULT_LAB_ID = "mdrtb.specimenReports.defaultLabId";
	...
	public static EncounterType ET_ADVERSE_EVENT = Context.getEncounterService().getEncounterType(Context.getAdministrationService().getGlobalProperty(GP_ENCOUNTER_TYPE_ADVERSE_EVENT));

	public static EncounterType ET_TRANSFER_IN = Context.getEncounterService().getEncounterType(Context.getAdministrationService().getGlobalProperty(GP_ENCOUNTER_TYPE_TRANSFER_IN));

	public static EncounterType ET_TRANSFER_OUT = Context.getEncounterService().getEncounterType(Context.getAdministrationService().getGlobalProperty(GP_ENCOUNTER_TYPE_TRANSFER_OUT));

	public static EncounterType ET_SPECIMEN_COLLECTION = Context.getEncounterService().getEncounterType(Context.getAdministrationService().getGlobalProperty(GP_ENCOUNTER_TYPE_SPECIMEN_COLLECTION));

	public static EncounterType ET_FORM89_TB_FOLLOWUP = Context.getEncounterService().getEncounterType(Context.getAdministrationService().getGlobalProperty(GP_ENCOUNTER_TYPE_FORM_89));

	public static EncounterType ET_TB03_TB_INTAKE = Context.getEncounterService().getEncounterType(Context.getAdministrationService().getGlobalProperty(GP_ENCOUNTER_TYPE_TB03));

	public static EncounterType ET_TB03U_MDRTB_INTAKE = Context.getEncounterService().getEncounterType(Context.getAdministrationService().getGlobalProperty(GP_ENCOUNTER_TYPE_TB03U_MDR));

	public static EncounterType ET_TB03U_XDRTB_INTAKE = Context.getEncounterService().getEncounterType(Context.getAdministrationService().getGlobalProperty(GP_ENCOUNTER_TYPE_TB03U_XDR));

	public static EncounterType ET_LAB_RESULT = Context.getEncounterService().getEncounterType(Context.getAdministrationService().getGlobalProperty(GP_ENCOUNTER_TYPE_LAB_RESULT));

	public static EncounterType ET_RESISTANCE_DURING_TREATMENT = Context.getEncounterService().getEncounterType(Context.getAdministrationService().getGlobalProperty(GP_ENCOUNTER_TYPE_RESISTANCE_DURING_TREATMENT));

	public static EncounterType ET_PV_REGIMEN = Context.getEncounterService().getEncounterType(Context.getAdministrationService().getGlobalProperty(GP_ENCOUNTER_TYPE_PV_REGIMEN));
