...
public interface Test extends Comparable<Test> {
	 ...
	 * status: the current status of the test (i.e., ordered, received, completed, etc) (this should be a calculated based on the existing data and some set of rules) 
	 * dateCollected: the date
