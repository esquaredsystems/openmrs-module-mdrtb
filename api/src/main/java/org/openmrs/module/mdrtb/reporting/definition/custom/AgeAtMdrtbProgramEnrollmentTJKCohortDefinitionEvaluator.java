...
public class AgeAtMdrtbProgramEnrollmentTJKCohortDefinitionEvaluator extends ProgramEnrollmentCohortDefinitionEvaluator {
	...
	public EvaluatedCohort evaluate(CohortDefinition cohortDefinition, EvaluationContext context) {
		...
		Map<Integer, List<MdrtbPatientProgram>> tbPatientProgramsMap = ReportUtil
		        .getMdrtbPatientProgramsEnrolledInDateRangeMap(cd.getEnrolledOnOrAfter(), cd.getEnrolledOnOrBefore());
