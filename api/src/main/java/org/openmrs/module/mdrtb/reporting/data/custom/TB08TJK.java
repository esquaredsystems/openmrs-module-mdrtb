...
public class TB08TJK implements ReportSpecification {
	...
	public String getName() {
		return Context.getService(MessagePropertyService.class).getMessage("mdrtb.tb08");
	}
	...
	public String getDescription() {
		return Context.getService(MessagePropertyService.class).getMessage("mdrtb.tb08.title");
	}
