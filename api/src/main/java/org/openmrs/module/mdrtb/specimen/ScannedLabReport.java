...
public interface ScannedLabReport {
	...
	/**
	 * Data this interface provides access get/set access to: lab: the lab where the test was
	 * performed Data this interface provides get access to: scannedLabReport: the actual object
	 * that stores the data this interface is providing access to (i.e., in our current
