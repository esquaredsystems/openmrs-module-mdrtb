 ...
 */
package org.openmrs.module.mdrtb.lab.aop;
...
public abstract class AOPContextSensitiveTest extends CommonLabTestBase implements TestAOP {
	 ...
	 * 
	 * @see
	 * org.openmrs.module.mdrtb.lab.aop.common.TestWithAOP#setAspect(java.lang.
	 * Class)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.openmrs.module.mdrtb.lab.aop.common.TestWithAOP#setAspect(org.
	 ...
	 * 
	 * @see
	 * org.openmrs.module.mdrtb.lab.aop.common.TestWithAOP#addService(java.lang.
	 * Class)
	 */
	@Override
	...
	public void setupAOP() throws Exception {
		...
		for (Class<?> serviceClass : servicesMap.keySet()) {
			Advice advice;
			if (adviceClass != null) {
				advice = (Advice) (new AdvicePoint(serviceClass.getCanonicalName(), Context.loadClass(adviceClass
