...
public class CommonLabTestDAOTest extends CommonLabTestBase {
	...
	public final void testSaveLabTestOrder_Create() {
		...
		assertThat(savedOrder, Matchers.hasProperty("orderId", Matchers.notNullValue()));
	}
	...
	public final void testSaveLabTestOrder_Update() {
		...
		assertThat(savedOrder, Matchers.hasProperty("orderId", Matchers.is(100)));
		assertThat(savedOrder, Matchers.hasProperty("urgency", Matchers.is(Urgency.STAT)));
	}
	...
	public final void testSaveLabTestAttribute() {
		...
		assertThat(resultLabTestAttribute, Matchers.hasProperty("uuid", Matchers.is(resultLabTestAttribute.getUuid())));
	}
	...
	public final void testSaveLabTestAttributeType() {
		...
		assertThat(savedAttributeType, Matchers.hasProperty("uuid", Matchers.is(attributeType.getUuid())));
		assertThat(savedAttributeType, Matchers.hasProperty("creator", Matchers.is(attributeType.getCreator())));
	}
	...
	public final void testSaveLabTestSample() {
		...
		assertThat(savedLabTestSample, Matchers.hasProperty("uuid", Matchers.is(testSample.getUuid())));
		assertThat(savedLabTestSample, Matchers.hasProperty("creator", Matchers.is(testSample.getCreator())));
	}
	...
	public final void testSaveLabTestType() {
		...
		assertThat(savedTestType, Matchers.hasProperty("uuid", Matchers.is(testType.getUuid())));
		assertThat(savedTestType, Matchers.hasProperty("creator", Matchers.is(testType.getCreator())));
	}
}
