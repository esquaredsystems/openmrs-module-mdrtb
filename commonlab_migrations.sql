...
values (9, 'Ã�Â²Ã�Â¾Ã�Â»Ã�Â¾Ã�Â½Ã‘â€šÃ�ÂµÃ‘â‚¬ (volunteer)', '', 'java.lang.String', NULL, 0, 1, '2011-11-08 11:31:01', 1, '2012-11-28 16:32:26', 1, 1, '2012-11-28 16:27:52', 'Not needed', NULL, 7.0, '8bd42c8c-52a9-4d6b-aede-e277706f9bec');
-- person_attribute
...
select location_id, name, description, 'Ã�Â¢Ã�Â¾Ã‘â€¡Ã�Â¸Ã�ÂºÃ�Â¸Ã‘ï¿½Ã‘â€šÃ�Â¾Ã�Â½ (Tajikistan)' as country, state_province, county_district, 1 as creator, date_created, retired, retired_by, date_retired, retire_reason, parent_location, uuid from _location l 
where location_id = 1;
...
select l.location_id, l.name, l.description, 'Ã�Â¢Ã�Â¾Ã‘â€¡Ã�Â¸Ã�ÂºÃ�Â¸Ã‘ï¿½Ã‘â€šÃ�Â¾Ã�Â½ (Tajikistan)' as country, l.state_province, l.county_district, 1 as creator, l.date_created, l.retired, p.location_id as parent_location, l.uuid from _location l 
...
-- Import Districts
insert into location (location_id, name, description, country, state_province, county_district, creator, date_created, retired, retired_by, date_retired, retire_reason, parent_location, uuid) 
select l.location_id, l.name, l.description, 'Ã�Â¢Ã�Â¾Ã‘â€¡Ã�Â¸Ã�ÂºÃ�Â¸Ã‘ï¿½Ã‘â€šÃ�Â¾Ã�Â½ (Tajikistan)' as country, l.state_province, l.county_district, 1 as creator, l.date_created, l.retired, l.retired_by, l.date_retired, l.retire_reason, p.location_id as parent_location, l.uuid from _location l 
inner join _location as p on p.name = l.parent_location 
...
select l.location_id, l.name, l.description, 'Ã�Â¢Ã�Â¾Ã‘â€¡Ã�Â¸Ã�ÂºÃ�Â¸Ã‘ï¿½Ã‘â€šÃ�Â¾Ã�Â½ (Tajikistan)' as country, l.state_province, l.county_district, 1 as creator, l.date_created, l.retired, l.retired_by, l.date_retired, l.retire_reason, l.uuid from _location l 
...
select * from patient_identifier where identifier = '19220038';
select * from person where person_id = 334015;

select * from obs where encounter_id = 219697;
select * from orders where order_id in (670891,673157,674731,674733);
select * from commonlabtest_test where test_order_id in (670891,673157,674731,674733);
select * from encounter e where e.encounter_id in (707741,717311,723987,723991);
